declare module 'excel4node' {
    ...
    export class Worksheet {
        ...
        /**
         * Conditional formatting adds custom formats in response to cell reference state. A subset of conditional
         * formatting features is currently supported by excel4node.
    ...
    export class Workbook {
        ...
        /**
         * The writeToBuffer() method access no parameters and returns a promise that resolves with the nodebuffer
         * generated by the JSZip library. This buffer can then be sent to other streams.
         */
    ...
    interface WorksheetOption {
        ...
        sheetView?: {
            ...
            pane?: {
                ...
                topLeftCell?: string;
                /**
                 * Horizontal position of the split, in 1/20th of a point; 0 (zero) if none. If the pane is frozen, this
                 * value indicates the number of columns visible in the top pane.
                 */
                xSplit?: number;
                /**
                 * Vertical position of the split, in 1/20th of a point; 0 (zero) if none. If the pane is frozen, this
                 * value indicates the number of rows visible in the left pane.
                 */
                ySplit?: number;
            };
            /**
             * Flag indicating whether the sheet is in 'right to left' display mode. When in this mode, Column A is on
             * the far right, Column B ;is one column left of Column A, and so on. Also, information in cells is
        ...
        sheetFormat?: {
            /**
             * Defaults to 10. Specifies the number of characters of the maximum digit width of the normal style's font.
        ...
        /**
         *   Flag indicating whether to remove the "spans" attribute on row definitions. Including spans in an
         *   optimization for Excel file readers but is not necessary
         */
    ...
    interface WorksheetValidation {
        ...
        /**
         * Restricts input to a specific set of characters. One of 'noControl', 'off', 'on', 'disabled', 'hiragana',
         * 'fullKatakana', 'halfKatakana', 'fullAlpha', 'halfAlpha', 'fullHangul', 'halfHangul'
         */
        imeMode?:
            | 'noControl'
            | 'off'
    ...
    interface RowColumnBase {
        ...
        freeze(num: number): RowColumnBase; // Freezes the first two columns and scrolls the right view to column
        /**
         * Add Filters to a row If not options are given to the filter function, a filter will be added to all columns
         * that contain data. Optionally, if you wish to restrict your filter to a specific range, you can specify start
         * and end rows and columns for that range. The filter row should be included in this range.
         */
    ...
    interface Cell {
        ...
        /**
         * accepts the same object as when creating a new style. When applied to a cell that already has style
         * formatting, the original formatting will be kept and updated with the changes sent to the style function.
         */
